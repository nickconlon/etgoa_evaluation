...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 270, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 230, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_20.setGeometry(QtCore.QRect(10, 190, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.cameraFF_connected_indicator.setGeometry(QtCore.QRect(150, 40, 41, 21))
        ...
        self.label_11.setGeometry(QtCore.QRect(200, 40, 91, 21))
        ...
        self.recording_connected_indicator = QtWidgets.QLabel(self.frame_5)
        self.recording_connected_indicator.setGeometry(QtCore.QRect(150, 80, 41, 21))
        self.recording_connected_indicator.setFrameShape(QtWidgets.QFrame.Box)
        self.recording_connected_indicator.setText("")
        self.recording_connected_indicator.setObjectName("recording_connected_indicator")
        self.label_12 = QtWidgets.QLabel(self.frame_5)
        self.label_12.setGeometry(QtCore.QRect(200, 80, 91, 21))
        ...
        self.set_home_button = QtWidgets.QPushButton(self.frame_9)
        self.set_home_button.setGeometry(QtCore.QRect(20, 140, 201, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.add_obstacle_frame = QtWidgets.QFrame(self.mission_control_panel)
        self.add_obstacle_frame.setGeometry(QtCore.QRect(10, 30, 651, 81))
        ...
        self.obstacle_confirm.setGeometry(QtCore.QRect(540, 10, 101, 61))
        ...
        self.mode_add_obstacle = QtWidgets.QRadioButton(self.add_obstacle_frame)
        self.mode_add_obstacle.setGeometry(QtCore.QRect(450, 10, 82, 17))
        self.mode_add_obstacle.setObjectName("mode_add_obstacle")
        self.mode_del_obstacle = QtWidgets.QRadioButton(self.add_obstacle_frame)
        self.mode_del_obstacle.setGeometry(QtCore.QRect(450, 30, 82, 17))
        self.mode_del_obstacle.setObjectName("mode_del_obstacle")
        self.mode_update_obstacle = QtWidgets.QRadioButton(self.add_obstacle_frame)
        self.mode_update_obstacle.setGeometry(QtCore.QRect(450, 50, 82, 17))
        self.mode_update_obstacle.setObjectName("mode_update_obstacle")
        self.add_obstacle_frame_2 = QtWidgets.QFrame(self.mission_control_panel)
        self.add_obstacle_frame_2.setGeometry(QtCore.QRect(10, 140, 651, 81))
        self.add_obstacle_frame_2.setFrameShape(QtWidgets.QFrame.Box)
        self.add_obstacle_frame_2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.add_obstacle_frame_2.setObjectName("add_obstacle_frame_2")
        self.poi_scroll = QtWidgets.QComboBox(self.add_obstacle_frame_2)
        self.poi_scroll.setGeometry(QtCore.QRect(10, 10, 161, 61))
        self.poi_scroll.setObjectName("poi_scroll")
        self.poi_x = QtWidgets.QTextEdit(self.add_obstacle_frame_2)
        self.poi_x.setGeometry(QtCore.QRect(200, 40, 61, 31))
        self.poi_x.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.poi_x.setTabChangesFocus(True)
        self.poi_x.setObjectName("poi_x")
        self.poi_y = QtWidgets.QTextEdit(self.add_obstacle_frame_2)
        self.poi_y.setGeometry(QtCore.QRect(290, 40, 61, 31))
        self.poi_y.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.poi_y.setTabChangesFocus(True)
        self.poi_y.setObjectName("poi_y")
        self.poi_confirm = QtWidgets.QPushButton(self.add_obstacle_frame_2)
        self.poi_confirm.setGeometry(QtCore.QRect(540, 10, 101, 61))
        self.poi_confirm.setFocusPolicy(QtCore.Qt.TabFocus)
        self.poi_confirm.setObjectName("poi_confirm")
        self.label_21 = QtWidgets.QLabel(self.add_obstacle_frame_2)
        self.label_21.setGeometry(QtCore.QRect(200, 10, 61, 21))
        self.label_21.setAlignment(QtCore.Qt.AlignCenter)
        self.label_21.setObjectName("label_21")
        self.label_24 = QtWidgets.QLabel(self.add_obstacle_frame_2)
        self.label_24.setGeometry(QtCore.QRect(290, 10, 61, 21))
        self.label_24.setAlignment(QtCore.Qt.AlignCenter)
        self.label_24.setObjectName("label_24")
        self.mode_update_poi = QtWidgets.QRadioButton(self.add_obstacle_frame_2)
        self.mode_update_poi.setGeometry(QtCore.QRect(450, 50, 82, 17))
        self.mode_update_poi.setObjectName("mode_update_poi")
        self.mode_add_poi = QtWidgets.QRadioButton(self.add_obstacle_frame_2)
        self.mode_add_poi.setGeometry(QtCore.QRect(450, 10, 82, 17))
        self.mode_add_poi.setObjectName("mode_add_poi")
        self.mode_del_poi = QtWidgets.QRadioButton(self.add_obstacle_frame_2)
        self.mode_del_poi.setGeometry(QtCore.QRect(450, 30, 82, 17))
        self.mode_del_poi.setObjectName("mode_del_poi")
        self.label_26 = QtWidgets.QLabel(self.mission_control_panel)
        self.label_26.setGeometry(QtCore.QRect(0, 0, 671, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_28 = QtWidgets.QLabel(self.mission_control_panel)
        self.label_28.setGeometry(QtCore.QRect(0, 110, 671, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.start_recording_button = QtWidgets.QPushButton(self.mission_panel)
        self.start_recording_button.setGeometry(QtCore.QRect(10, 50, 251, 61))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.stop_recording_button = QtWidgets.QPushButton(self.mission_panel)
        self.stop_recording_button.setGeometry(QtCore.QRect(290, 50, 251, 61))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(False)
        font.setWeight(50)
        self.stop_recording_button.setFont(font)
        self.stop_recording_button.setObjectName("stop_recording_button")
        self.label_29 = QtWidgets.QLabel(self.mission_panel)
        self.label_29.setGeometry(QtCore.QRect(0, 0, 551, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "FPV Camera"))
        self.label_22.setText(_translate("MainWindow", "System and Network"))
        self.label_12.setText(_translate("MainWindow", "Recording"))
        ...
        self.label_23.setText(_translate("MainWindow", "Robot Planning"))
...
"Drive"))
        self.obstacle_confirm.setText(_translate("MainWindow", "Submit"))
        ...
        self.mode_add_obstacle.setText(_translate("MainWindow", "Add"))
        self.mode_del_obstacle.setText(_translate("MainWindow", "Delete"))
        self.mode_update_obstacle.setText(_translate("MainWindow", "update"))
        self.poi_confirm.setText(_translate("MainWindow", "Submit"))
        self.label_21.setText(_translate("MainWindow", "Center X"))
        self.label_24.setText(_translate("MainWindow", "Center Y"))
        self.mode_update_poi.setText(_translate("MainWindow", "update"))
        self.mode_add_poi.setText(_translate("MainWindow", "Add"))
        self.mode_del_poi.setText(_translate("MainWindow", "Delete"))
        self.label_26.setText(_translate("MainWindow", "Add/Delete/Update Obstacles"))
        self.label_28.setText(_translate("MainWindow", "Add/Delete/Update POIs"))
        ...
        self.label_29.setText(_translate("MainWindow", "Data Recording"))
