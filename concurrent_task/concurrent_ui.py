...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mission_control_text.setGeometry(QtCore.QRect(10, 850, 871, 71))
        font = QtGui.QFont()
        ...
        self.longitude_label.setGeometry(QtCore.QRect(910, 890, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.submit_button.setGeometry(QtCore.QRect(1330, 850, 141, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.latitude_label.setGeometry(QtCore.QRect(910, 850, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.latitude_input = QtWidgets.QLineEdit(self.frame)
        self.latitude_input.setGeometry(QtCore.QRect(1060, 850, 251, 31))
        self.latitude_input.setMaxLength(5)
        self.latitude_input.setObjectName("latitude_input")
        self.longitude_input = QtWidgets.QLineEdit(self.frame)
        self.longitude_input.setGeometry(QtCore.QRect(1060, 890, 251, 31))
        self.longitude_input.setMaxLength(5)
        self.longitude_input.setObjectName("longitude_input")
        self.next_button = QtWidgets.QPushButton(self.frame)
        self.next_button.setGeometry(QtCore.QRect(1490, 850, 141, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.next_button.setFont(font)
        self.next_button.setFocusPolicy(QtCore.Qt.StrongFocus)
